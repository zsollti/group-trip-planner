...
/**
 * Deck-paradigm propose/edit dialog for an option (FR-21 fields). On edit it
 * carries the option `version` (a 409 = changed or locked → reload). Validation
 * is the server contract's job; this only shapes the payload (blanks omitted,
 * local datetimes → ISO).
 */
  ...
  return (
    ...
    >
      <form
        ...
        noValidate
      >
        <p className="deck__eyebrow">{isEdit ? "Edit" : "Propose"}</p>
