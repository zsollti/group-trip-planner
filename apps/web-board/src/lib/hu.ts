...
export const HU_UI_MESSAGES: Readonly<Record<string, string>> = {
  ...
  "Amount (optional)": "Összeg (nem kötelező)",
  ...
  "Dates not settled ·": "A dátumok még nincsenek eldöntve ·",
  Decided: "Eldöntve",
  ...
  "End time (optional)": "Befejezés (nem kötelező)",
  ...
  Notes: "Megjegyzések",
  "Notes (optional)": "Megjegyzések (nem kötelező)",
