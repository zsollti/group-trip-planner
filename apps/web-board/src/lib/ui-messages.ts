...
export const UI_MESSAGES = [
  ...
  " cal__head--outside",
  " cost-comp__row--on",
  " cost-comp__swatch--tail",
  " cost-donut__wedge--off",
  " cost-donut__wedge--on",
  " cost-donut__wedge--tail",
  " lane__card--dragging",
  " lane__card--settled",
  " lane__dates--elsewhere",
  " lane__decide-drop--over",
  " lane__vote-btn--on",
  " lane__voter--stale",
  " menu__item--danger",
  " menu__list--left",
  ...
  "your address",
  "yours: ",
  "{amount} over target, per person",
  "{amount} per person",
  "{amount} per person for {who}",
