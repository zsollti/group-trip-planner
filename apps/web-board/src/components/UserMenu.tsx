 ...
 * light/dark toggle, Log out, and Delete account. Separated from the trip-context
 * actions so account controls stay consistent across the dashboard and the board.
 */
